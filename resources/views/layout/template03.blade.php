...
<body>
    ...
    <div class="container s">
         <h3>@yield('isi')</h3>
        <center><img src="GAMBAR/ss1.png" alt="code1" width="1200px" height="auto" margin-bottom="50px"></center>
        <center><img src="GAMBAR/ss2.png" alt="code1" width="1200px" height="auto" margin-bottom="50px"></center>
    ...
    <small>Copyright &copy; 2022 - DEKKRISNA. All Rights Reserved.</small>
